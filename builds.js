	...
	if(tabActive !== null && tabActive !== undefined)
	{
		...
		}else if(tabItem.getAttribute("href").indexOf("t=5")>=0)
		{
			...
			if(marketSend_ !== null && marketSend_ !== undefined)
			{
				...
				button_Smallcelebration.setAttribute("style","background-color:green;border:none;color:white;padding: 3px;");
				...
				button_Bigcelebration.setAttribute("style","background-color:green;border:none;color:white;padding: 3px;");
				...
				button_Bigcelebration2.setAttribute("style","background-color:green;border:none;color:white;padding: 3px;");
				...
				button_Bigcelebration3.setAttribute("style","background-color:green;border:none;color:white;padding: 3px;");
